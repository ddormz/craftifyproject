function statusCotTable() {
    var table = $(".tabla-stCot").DataTable({
      "responsive": true,
      "lengthChange": false,
      "autoWidth": false,
      "language": {
...
$(document).ready(function() {
    $("#formularioStCot").on("submit", function(event) {
  ...
  document.addEventListener('DOMContentLoaded', statusCotTable);
